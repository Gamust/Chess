...
# INSERT CHESS PIECES
bpawn = pygame.image.load("Chess_in_python/Pieces/BPawn.png").convert_alpha()
bpawn = pygame.transform.scale(bpawn,IMAGE_SIZE)
wpawn = pygame.image.load("Chess_in_python/Pieces/WPawn.png").convert_alpha()
wpawn = pygame.transform.scale(wpawn,IMAGE_SIZE)
brook = pygame.image.load("Chess_in_python/Pieces/BRook.png").convert_alpha()
brook = pygame.transform.scale(brook,IMAGE_SIZE)
wrook = pygame.image.load("Chess_in_python/Pieces/WRook.png").convert_alpha()
wrook = pygame.transform.scale(wrook,IMAGE_SIZE)
bking = pygame.image.load("Chess_in_python/Pieces/BKing.png").convert_alpha()
bking = pygame.transform.scale(bking,IMAGE_SIZE)
wking = pygame.image.load("Chess_in_python/Pieces/WKing.png").convert_alpha()
wking = pygame.transform.scale(wking,IMAGE_SIZE)
bqueen = pygame.image.load("Chess_in_python/Pieces/BQueen.png").convert_alpha()
bqueen = pygame.transform.scale(bqueen,IMAGE_SIZE)
wqueen = pygame.image.load("Chess_in_python/Pieces/WQueen.png").convert_alpha()
wqueen = pygame.transform.scale(wqueen,IMAGE_SIZE)
bknight = pygame.image.load("Chess_in_python/Pieces/BKnight.png").convert_alpha()
bknight = pygame.transform.scale(bknight,IMAGE_SIZE)
wknight = pygame.image.load("Chess_in_python/Pieces/WKnight.png").convert_alpha()
wknight = pygame.transform.scale(wknight,IMAGE_SIZE)
bbishop = pygame.image.load("Chess_in_python/Pieces/BBishop.png").convert_alpha()
bbishop = pygame.transform.scale(bbishop,IMAGE_SIZE)
wbishop = pygame.image.load("Chess_in_python/Pieces/WBishop.png").convert_alpha()
